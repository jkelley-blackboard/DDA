...
For full column-level detail, use the [Expanded Schema Explorer](https://jkelley-blackboard.github.io/DDA/schema-4000.10.0/schema/index.html).
...
> ⚠️ Grade table names and column names have not yet been verified against the schema. This section will be added once confirmed. Use the [Schema Explorer](https://jkelley-blackboard.github.io/DDA/schema-4000.10.0/schema/index.html) to browse the `bb_bb60_*` tables in the meantime.
